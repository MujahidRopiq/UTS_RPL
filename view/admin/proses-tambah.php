...
if ($gambar_product != "") {
  ...
  if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
    ...
    $query = "INSERT INTO product 
                    (id_product, id_admin, kode_product, tgl_input, harga, nama_product, keterangan, foto) 
                    VALUES 
                    ('', '$kode_product', '$id_admin', '$date', '$harga_product', '$nama_product', '$keterangan', '$nama_gambar_baru')";
  ...
  $query = "INSERT INTO product 
    ...
    VALUES 
    ('', '$kode_product', '$id_admin', '$date', '$harga_product', '$nama_product', '$keterangan', null)";
  $result = mysqli_query($conn, $query);
  // periska query apakah ada error
  if (!$result) {
    die("Query gagal dijalankan: " . mysqli_errno($$conn) .
